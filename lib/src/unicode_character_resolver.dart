...
_UnicodeCanonicalClass _getUnicodeCanonicalClass(int character) {
  final r = _canonClass[character] ?? _UnicodeCanonicalClass.NR;
  return r;
}

/// Gets the Unicode decomposition mapping.
List<int>? getUnicodeDecompositionMapping(int character) {
  return _decomMapping[character];
}
